    ...
    <div className="max-w-6xl mx-auto mt-8">
      <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <Container>
          ...
          <div className="text-green-600 flex items-center gap-2 mt-2"><BsGraphUpArrow /> On Track</div>
        </Container>
        <Container>
          <div className="flex items-center justify-between">
            <p>Streak</p>
          ...
          <div className="px-3 py-1 bg-gray-200 rounded-2xl mt-2 inline-block font-medium">🔥 Hot Streak! </div>
        </Container>
      </div>
        ...
        <Container> 
          ...
          <div style={{width: "100%", height: 300}} className="my-6">
            <ResponsiveContainer>
              ...
              <p className="text-center mt-0">in Kg</p>
            </ResponsiveContainer>
          </div>
        </Container>
        <Container>
          ...
          <div style={{width: "100%", height: 300}} className="mb-6 mt-0">
            <ResponsiveContainer>
              ...
              <div className="mt-0 flex gap-4 justify-center items-center">
